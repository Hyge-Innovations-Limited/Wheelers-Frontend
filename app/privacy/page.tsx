...
const policySections = [
  ...
  },
  {
    ...
    body: [
      ...
      "Nearby ride alerts (optional): drivers can choose to switch on Nearby ride alerts in the app's Settings. When it is on, the Wheelers Driver app collects an approximate location about every 10 minutes in the background while the driver is signed in but offline, including when the app is closed or not in use. We use it so our team can alert or call the driver about riders close by, and for driver safety. It is off by default, it never puts a driver online or accepts a ride for them, and this off-shift location is not shown to riders. A driver can switch it off at any time, which stops collection and deletes the stored off-shift location. Location history is kept for up to 14 days and then deleted.",
